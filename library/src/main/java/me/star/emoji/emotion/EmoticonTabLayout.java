...
public class EmoticonTabLayout {
    ...
    private EmoticonTabLayout.TabPagerAdapter mAdapter;
    ...
    private View.OnClickListener tabClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            int count = EmoticonTabLayout.this.mScrollTab.getChildCount();
            if (count > 0) {
                for (int i = 0; i < count; ++i) {
                    if (v.equals(EmoticonTabLayout.this.mScrollTab.getChildAt(i))) {
                        EmoticonTabLayout.this.mViewPager.setCurrentItem(i);
                        break;
                    }
                }
            }
    ...
    public void refreshTabIcon(IEmoticonTab tab, Drawable drawable) {
        ...
        if (index >= 0) {
            ...
            ImageView iv = (ImageView) child.findViewById(R.id.emoticon_tab_iv);
    ...
    private View initView(Context context, ViewGroup parent) {
        View container = LayoutInflater.from(context).inflate(R.layout.emoticon_tab_container, (ViewGroup) null);
        ...
        this.mViewPager = (ViewPager) container.findViewById(R.id.view_pager);
        this.mScrollTab = (ViewGroup) container.findViewById(R.id.emotion_scroll_tab);
        View tabBar = container.findViewById(R.id.emotion_tab_bar);
        ...
        this.mTabAdd = container.findViewById(R.id.emoticon_tab_add);
        ...
        this.mTabAdd.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (EmoticonTabLayout.this.mEmoticonClickListener != null) {
                    EmoticonTabLayout.this.mEmoticonClickListener.onAddClick(v);
                }
        ...
        this.mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                EmoticonTabLayout.this.onPageChanged(EmoticonTabLayout.this.selected, position);
                EmoticonTabLayout.this.selected = position;
            }
    ...
    private View getTabIcon(Context context, IEmoticonTab tab) {
        ...
        View item = LayoutInflater.from(context).inflate(R.layout.emoticon_tab_item, (ViewGroup) null);
        item.setLayoutParams(new RelativeLayout.LayoutParams(DisplayUtils.dip2px(60.0F), DisplayUtils.dip2px(36.0F)));
        ImageView iv = (ImageView) item.findViewById(R.id.emoticon_tab_iv);
        iv.setImageDrawable(drawable);
    ...
    private void onPageChanged(int pre, int cur) {
        ...
        if (count > 0 && cur < count) {
            ...
            if (cur >= 0) {
                ...
                if (w != 0) {
                    int screenW = DisplayUtils.getWindowWidth();
                    if (this.mAddEnabled) {
    ...
    private class TabPagerAdapter extends PagerAdapter {
        ...
        public int getCount() {
            return EmoticonTabLayout.this.getAllTabs().size();
        }
